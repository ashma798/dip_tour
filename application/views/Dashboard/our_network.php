...
.submit::-moz-focus-inner { 
  ...
  margin-bottom: 0.5em;
                       ...
                       <form action="<?php echo base_url('/Dashboard/addOurNetwork'); ?>" method="post">
                       <textarea class="summernote" rows="8" cols="100"  name="our_network" placeholder="Edit diptour footer info....."><?php echo $our_network;?>
</textarea>
