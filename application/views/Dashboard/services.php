...
.submit::-moz-focus-inner { 
  ...
  margin-bottom: 0.5em;
                       ...
                       <form action="<?php echo base_url('/Dashboard/addServices'); ?>" method="post">
                       <textarea class="summernote" rows="8" cols="100"  name="services" placeholder="Edit diptour footer info....."><?php echo $services;?>
</textarea>
