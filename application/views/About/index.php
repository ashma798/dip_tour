                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-6">
                            ...
                            <div class="footer-pad">
                                ...
                                <ul class="list-unstyled nav-flex-icons" style="margin-top: 25px; margin-right: 20px;">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="new">
                                    ...
                                    <div class="content">
                                        <p>You can get latest update from us by subscribing to
                                            ...
                                            <span class="input-group-btn" ">
                                                <button class="btn" style="margin-left: 0px; margin-top: 0px; type="submit">Subscribe</button>
                                            </span>
                                        </div> #059f05
                                    </div>
                                </div>
                                ...
                                <a href="https://www.facebook.com/diptourltd" class="fa fa-facebook nav-flex-icons"></a> &nbsp; &nbsp;
