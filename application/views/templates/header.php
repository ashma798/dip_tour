                   ...
                   <li >
                    ...
                    <li >
                       <a class="nav-link " href="<?php echo base_url('Dashboard/flights');?>"> <i class="fa fa-th-large"></i> <span class="title">Flight</span> <i class="" aria-hidden="true"></i> </a>
						...
						<li >
                       <a class="nav-link " href="<?php echo base_url('Dashboard/UserList');?>"> <i class="fa fa-th-large"></i> <span class="title">User List</span<i class ="" aria-hidden="true"></i></a>
                         
                    </li>
                    <li >
                       <a class="nav-link " href="<?php echo base_url('Dashboard/newsletter_content');?>"> <i class="fa fa-th-large"></i> <span class="title">Newsletter</span<i class ="" aria-hidden="true"></i></a>
