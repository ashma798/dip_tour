...
@media screen and (max-width: 990px) and (min-width: 320px) {
    ...
    text-transform: capitalize;">Send Us a message to discuss your Visa needs for Dubai - UAE</h3>
...
<form method="post" action="<?php echo base_url('/visa/addDubaiUAE'); ?>" enctype="multipart/form-data">
  <div>
  <p>
    <label>
     Prefix<span style="color:red;">*</span><br>
    <select name="prefix" >
  ...
  <p>
    <label>
      Nationality<span style="color:red;">*</span><br>
  ...
  <p>
    ...
    <select placeholder="" name="employment_status">
  ...
  <div>
  <h6 style="color: black;  font-weight: bold;">Travel Information</h6>
</div>
<div>
<p>
    <label>
      Intended Arrival Date<span style="color:red;">*</span><br>
    <input type="date" name="intended_arrival_date">
    </label>
  </p>

  <p>
    <label>
      Intended Return Date<span style="color:red;">*</span><br>
    <input type="date" name="intended_return_date">
    </label>
  </p>
  <p>
    <label>
  ...
  <p>
    <label>
      Have you been to any of the following destinations in the last five years ?
      <span style="color:red;">*</span> <br>
      <input type="checkbox" name="went_to_uk" value="yes"> UK <br>
      <input type="checkbox" name="went_to_usa" value="yes"> USA <br>
      <input type="checkbox" name="went_to_uae" value="yes"> UAE <br>
      <input type="checkbox" name="went_to_south_africa" value="yes"> South Africa<br>
      <input type="checkbox" name="went_to_asia" value="yes"> Asia<br>
      <input type="checkbox" name="went_to_others" value="yes"> Others<br>
      <input type="checkbox" name="went_to_none" value="yes"> None<br>

    </label>
  </p>
</div>
  <div>
  <h6 style="color: black;  font-weight: bold;">Passport Information</h6>
</div>
<div>
      <p>
    <label>
      Passport Number <span style="color:red;">*</span> <br>
    <input type="text" placeholder="Passport Number" name="pasport_number">

    </label>
  </p>
    <p>
    <label>
      Passport Expiry <span style="color:red;">*</span> <br>
    <input type="date" placeholder="Passport Expiry" name="pasport_expiry">

    </label>
  </p>
  <p>
    <label>
      Scanned Copy of Data Page <span style="color:red;">*</span> <br>
    <input type="file" placeholder="upload scanned copy of data page" name="scanned_data_page">

    </label>
  </p>
  <p>
    <label>
     Data Page of Parent/Guardian/Spouse <span style="color:red;">*</span> <br>
    <input type="file" placeholder="upload scanned copy of data page" name="scanned_data_page_parent_guardian_spouse">
