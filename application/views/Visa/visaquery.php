...
<meta name="viewport" content="width=device-width, initial-scale=1">
 ...
 <link href="<?php echo base_url(); ?>css/sty1.css" rel="stylesheet">
...
<nav class="navbar navbar-expand-sm   sticky-top " style="background-color: black;">
  <a class="navbar-brand" href="#" style="padding-left: 100px; color: white;">Nigeria's No.1 Tour Management Company</a>
...
<li class="nav-item"><a class="nav-link"  href="" style="color: white;">ENG</a></li>
...
<div class="topnav" style="background-color: white;">
      <img class="" src="<?php echo base_url(); ?>images/logo.png" alt=""  style="padding-left: 70px; padding-top: 40px;" />
...
<nav class="navbar navbar-expand-sm navbar-ch">
    ...
    <div class="navbar-collapse collapse" id="navbarCustom">
      <span class="rounded-bottom"></span>
        <ul class="navbar-nav" style=" padding-left: 60px;">
            ...
            <li class="nav-item"><a class="nav-link"  href="" style="color: black;">|</a></li>
            <li class="nav-item">
                <a class="nav-link" href="flightsearch.html" style="color: black;">FLIGHTS</a>
            </li>
            <li class="nav-item"><a class="nav-link"  href="" style="color: black;">|</a></li>
            <li class="nav-item">
                <a class="nav-link" href="car.html" style="color: black;">CAR RENTALS</a>
            </li>
            <li class="nav-item"><a class="nav-link"  href="" style="color: black;">|</a></li>
            ...
            <li class="nav-item"><a class="nav-link"  href="" style="color: black;">|</a></li>
              ...
              <a class="nav-link" href="visa_1.html" style="color: black;">VISAS</a>
...
<section class="container p-t-3">
    <div class="row" style="margin-top:0px; margin-bottom: 50px;border-radius: 5px solid ">
        <div class="col-lg-12">
     ...
     <div class="col-md-4">
      <div class="card border-success mb-3">
        ...
        <div class="card-body ">
           ...
           <img src="<?php echo base_url(); ?>images/card1.jpg">
     ...
     <div class="col-md-4">
      <div class="card border-success mb-3">
        ...
        <div class="card-body ">
           ...
           <img src="<?php echo base_url(); ?>images/card2.jpg">
          <p class="card-text" style="padding-bottom: 50px;">For every season, get connected and be updated with top travel deals and discounted / promotional fares of different travel products; inclusive of Flight Tickets, Hotels, Tour Packages and other exciting tour services globally</p>
    ...
    <div class="col-md-4">
      <div class="card border-success mb-3">
        ...
        <div class="card-body ">
           ...
           <img src="<?php echo base_url(); ?>images/card_1.jpg">
     ...
     <div class="col-md-4">
      <div class="card border-success mb-3">
        ...
        <div class="card-body ">
           ...
           <img src="<?php echo base_url(); ?>images/card4.jpg">
     ...
     <div class="col-md-4">
      <div class="card border-success mb-3">
        ...
        <div class="card-body ">
           ...
           <img src="<?php echo base_url(); ?>images/card6.jpg">
...
<section style="padding-left: 40px;padding-right: 40px;">
    <div class="container" >
      ...
      <img src="<?php echo base_url(); ?>images/par1.jpg">
    ...
    <div class="card" style="width:300px;">
      <img  src="<?php echo base_url(); ?>images/par2.jpg">
      <div class="off_div">2N / 3D</div>
      <div class="card-block">
    ...
    <div class="card" style="width:300px;">
      <img  src="<?php echo base_url(); ?>images/par3.jpg">
      <div class="off_div">2N / 3D</div>
      <div class="card-block">
        <h6 class="card-title">This almost brought the Internet to its knees</h6>
...
<div class="container mt-4">
  <div class="row" >
     ...
     <div class="col-md-4  pl-5">
      <div class="card pl-4" style="background-color: #D3D3D3; width:300px;">
       
        <img class="card-img-top" src="<?php echo base_url(); ?>images/logo1.png" alt="Card image top" style="padding-left: 60px;height:70px; width:150px; padding-top: 25px;">
        <div class="card-body">
              ...
              <div class="col-md-7">
                ...
                <div class="col-md-2">
                  <div class="col_box" style="padding-bottom: 20px;">
                    <img class="img-responsive " src="<?php echo base_url(); ?>images/c1.png"><p>Best Price</p>
                  </div>
                </div>

                <div class="col-md-2">
                  <div class="col_box" style="margin-left:60px; padding-bottom: 20px;">
                    <img class="img-responsive " src="<?php echo base_url(); ?>images/c2.png"><p>Easy Booking</p>
                  </div>
                </div>
             
              
                <div class="col-md-2">
                  <div class=" col_box" style="margin-left: 120px; padding-bottom: 20px;"><img class="img-responsive " src="<?php echo base_url(); ?>images/c3.png"><p>Trust &amp; Safety</p></div>
                </div>
                ...
                <div class="col-md-2">
                  <div class="col_box" style=" padding-bottom: 20px;">
                    <img class="img-responsive " src="<?php echo base_url(); ?>images/c4.png"><p>24/7 Customer Support</p>
                  </div>
                </div>
                <div class="col-md-2">
                  <div class="col_box" style="margin-left:60px; padding-bottom: 20px;">
                    <img class="img-responsive " src="<?php echo base_url(); ?>images/c2.png"><p>Excellent Deliverables</p>
                  </div>
                </div>
             
              
                <div class="col-md-2">
                  <div class=" col_box" style="margin-left: 120px;  padding-bottom: 20px;"><img class="img-responsive " src="<?php echo base_url(); ?>images/c2.png"><p>Car Lease Display</p></div>
                </div>
  ...
  <p style="margin-top: 20px;">Thank you for booking the flight for us, you are the best we have seen in the market. </p>
        ...
        <div class="carousel-item">
          <blockquote>
              <div class="row">
                <div class="col-1 ">
                 <img src="<?php echo base_url(); ?>images/test4.jpg" style="margin-right:20px;"></div>
                <div class="col-9 offset-2">
    ...
    <div class="row">
      <div class="col-md-3 col-sm-6">
        ...
        <div class="footer-pad">
         <img class="" src="<?php echo base_url(); ?>images/logo.png">
